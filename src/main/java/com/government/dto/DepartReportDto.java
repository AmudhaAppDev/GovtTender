...
public class DepartReportDto {

	private String rdate,zone,address,department,ctype,status,description,email,filename,filetype,filesize,filecontent,encrypt,decrypt,estimate,duration,allocatedate,Statuss,companyname,requestamt,phash,ahash,uuid;
