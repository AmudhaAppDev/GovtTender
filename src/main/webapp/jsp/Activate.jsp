		...
		<div class="container-fluid">
			<table class="table-dark">
				...
				<tr>
					...
					<td><a href="/jsp//jsp/viewfile.jsp?filename=<%=rs.getString(8)%>"
						target="_blank"><button class="btn btn-primary">View</button></a></td>
					<td><a href="/jsp/Activateac.jsp?email=<%=rs.getString(3)%>"><button
								class="btn btn-primary">ACTIVATE</button></a></td>
