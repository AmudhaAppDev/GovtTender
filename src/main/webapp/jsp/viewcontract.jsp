		...
		<div class="container-fluid">
			<table class="table-dark">
				...
				<tr>
					...
					<td><a href="/jsp/viewfile.jsp?filename=<%=rs.getString(10)%>"
						target="_blank"><button class="btn btn-primary">VIEW</button></a></td>
					<td><a
						href="request.jsp?id=<%=rs.getString(24)%>&&department=<%=rs.getString(6)%>&&date=<%=rs.getString(18)%>&&zone=<%=Zone%>&&amount=<%=rs.getString(16)%>&&duration=<%=rs.getString(17)%>"><button
								class="btn btn-primary">REQUEST</button></a></td>
